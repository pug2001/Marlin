 ...
 */
  ...
  #define _MAX_PROBE_X (min(X_MAX_BED - (MIN_PROBE_EDGE) + X_BED_OVERRUN, X_MAX_POS + X_PROBE_OFFSET_FROM_EXTRUDER + X_BED_OVERRUN))
  #define _MAX_PROBE_Y (min(Y_MAX_BED - (MIN_PROBE_EDGE) + Y_BED_OVERRUN, Y_MAX_POS + Y_PROBE_OFFSET_FROM_EXTRUDER + Y_BED_OVERRUN))
