...
#define STRING_CONFIG_H_AUTHOR "(Pug2001, Anet A8 config)" // Who made the changes.
...
/* if the head can move outside the bed then the probe can sense nearer to the edge of the bed.*/
 #define X_BED_OVERRUN 10
 #define Y_BED_OVERRUN 0
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - MIN_PROBE_EDGE + X_PROBE_OFFSET_FROM_EXTRUDER + X_BED_OVERRUN)
  #define FRONT_PROBE_BED_POSITION MIN_PROBE_EDGE
  #define BACK_PROBE_BED_POSITION (Y_BED_SIZE - MIN_PROBE_EDGE) + Y_PROBE_OFFSET_FROM_EXTRUDER  + Y_BED_OVERRUN
